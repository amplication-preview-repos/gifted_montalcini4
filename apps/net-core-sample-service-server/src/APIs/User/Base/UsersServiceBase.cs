...
using NetCoreSampleService.APIs.Errors;
using NetCoreSampleService.APIs.Extensions;
...
{
    protected readonly NetCoreSampleServiceDbContext _context;

    public UsersServiceBase(NetCoreSampleServiceDbContext context)
    {
        _context = context;
    }
